# Generated by Django 2.1.7 on 2019-05-21 13:19
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('courses', django.contrib.postgres.fields.ArrayField(base_field=django.contrib.postgres.fields.ArrayField(base_field=models.CharField(default='none', max_length=30), size=None), size=None)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('instrument', models.CharField(default='none', max_length=30)),
                ('teacher', models.CharField(default='none', max_length=30)),
        ...
        migrations.AddField(
            ...
            name='musicLesson',
            field=models.OneToOneField(on_delete=django.db.models.deletion.PROTECT, to='BackendApp.MusicLesson'),
        ),
        migrations.AddField(
            model_name='courserequest',
            name='sport',
            field=models.OneToOneField(on_delete=django.db.models.deletion.PROTECT, to='BackendApp.Sport'),
        ),
        migrations.AddField(
            model_name='courserequest',
            name='topPriority',
            field=models.OneToOneField(on_delete=django.db.models.deletion.PROTECT, to='BackendApp.Course'),
        ),
    ]
